...
void odom_callback(const nav_msgs::Odometry::ConstPtr& msg)
{
  ...
  if(1)
  {
    ...
    trajROS.type            = visualization_msgs::Marker::SPHERE_LIST;
...
int main(int argc, char** argv)
{
  ...
  // ros::Subscriber sub_odom = n.subscribe("/ekf/ekf_odom", 100,  odom_callback);
